...
/* EXEC insertDeal @VenueFoursquareId = '555', @VenueName = 'Carrefour', @VenueAddress = 'Rod. D. Pedro I, Km 127', @VenueCity = 'Campinas', @VenueState = 'SP', @VenueCountry = 'Brasil', @VenueLatitude = -22.852876134654547, @VenueLongitude = -47.02767489301763, @CustomerFirstName = 'Patrick', @CustomerLastName = 'Tedeschi', @CustomerEmail = 'patrick@tedeschi.com.br', @CustomerCountry =  'Brasil', @ProductName = 'Premium Care', @ProductBrand = 'Pampers', @ProductModel = '', @ProductSize = 'M', @ProductQuantity = 48, @DealPrice = 51.89, @DealType = 'Consumer', @DealComment = '' */
/*==============================================================*/


CREATE PROCEDURE insertDeal @VenueFoursquareId nvarchar(40) = NULL, @VenueName nvarchar(40) = NULL, @VenueAddress nvarchar(40) = NULL, @VenueCity nvarchar(40) = NULL, @VenueState nvarchar(40) = NULL, @VenueCountry nvarchar(40) = NULL, @VenueLatitude float, @VenueLongitude float, @CustomerFirstName nvarchar(40) = NULL, @CustomerLastName nvarchar(40) = NULL, @CustomerEmail nvarchar(40) = NULL, @CustomerCountry nvarchar(40) = NULL, @ProductName nvarchar(50) = NULL, @ProductBrand nvarchar(50) = NULL, @ProductModel nvarchar(50) = NULL, @ProductSize nvarchar(50) = NULL, @ProductQuantity int, @DealPrice decimal(12,2), @DealType nvarchar(50) = NULL, @DealComment nvarchar(50) = NULL
AS
BEGIN
	...
	BEGIN TRANSACTION 
		INSERT INTO Venue (FoursquareId, Name, Address, City, State, Country, Latitude, Longitude) VALUES (@VenueFoursquareId, @VenueName, @VenueAddress, @VenueCity, @VenueState, @VenueCountry, @VenueLatitude, @VenueLongitude);
		...
		INSERT INTO Product (ProductName, Brand, Model, Size, Quantity) VALUES (@ProductName, @ProductBrand, @ProductModel, @ProductSize,  @ProductQuantity);
